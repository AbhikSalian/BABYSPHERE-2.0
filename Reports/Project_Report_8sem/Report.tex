...
\begin{figure}[hbtp]
\centering
\includegraphics[width=4in,height=2in]{./pic/flowchart.png}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=5in,height=3in]{./pic/flowchart.png}
...
This project can be further developed as:
 • By incorporating more real-world testing and gathering feedback from 
individual units.
 • The system can be connected with communication devices or services to enable
